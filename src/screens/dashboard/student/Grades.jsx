...
import PostGradeCard from "../../../components/dashboard/student/PostGradeCard";
import { fetchStudentPostGrades } from "../../../services";

function Grades() {
  const { postId } = useParams();
  const grades = useQuery(["studentPostGrades", postId], () =>
    fetchStudentPostGrades(postId)
  );
